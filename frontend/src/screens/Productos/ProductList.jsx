...
const ProductList = () => {
  ...
  useEffect(() => {
    fetch(`http://${SERVER_HOST}/api/publicaciones/tipo/Producto`)
      .then((res) => res.json())
      .then((data) => {
  ...
  function reloadData() {
    ...
    fetch(
      `http://${SERVER_HOST}/api/publicaciones/categoria/${categoria}`
    )
      .then((res) => res.json())
      .then((data) => {
        setPublicaciones(data);
  ...
  const searchPublicaciones = () => {
    const endpoint = search === ''
      ? `http://${SERVER_HOST}/api/publicaciones/tipo/Productos`
      : `http://${SERVER_HOST}/api/publicaciones/buscar/${search}`;
